...
VALUES ( '대한민국 서울특별시 강서구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 부산시 강동구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 천안시 강북구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 대구시 강ㅁㄴㅇㄹ구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 대전시 강test구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 안산시 강test2구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 인천시 강test3구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 포항시 강test4구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 서울특별시 강test5구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 서울특별시 강남구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 서울특별시 강남구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 서울특별시 강남구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 서울특별시 강남구 테헤란로 1', 37.4979, 127.0276, 'place_001'),
       ( '대한민국 서울특별시 강남구 테헤란로 1', 37.4979, 127.0276, 'place_001');
...
INSERT INTO restaurant ( name, main_menu, description, address, price, user_id, view, image_url, created_at,
                         updated_at, state)
VALUES ( '철수분식', '떡볶이', '매콤달콤한 즉석 떡볶이', '대한민국 test1시 강서구 테헤란로 1', 5000, 1, 0, '/img/res1.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP,'공개'),
       ( '영희카페', '아메리카노', '신선한 원두로 내린 커피', '대한민국 test2시 강남구 세종대로 175', 4500, 2, 0, '/img/res2.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '민수식당', '김치찌개', '얼큰한 돼지고기 김치찌개', '대한민국 test3시 강동구 독막로 12', 7000, 3, 0, '/img/res3.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '지훈치킨', '양념치킨', '바삭하고 달콤한 치킨', '대한민국 test4시 용산구 백제고분로 123', 16000, 4, 0, '/img/res4.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '은지쌀국수', '소고기쌀국수', '진한 육수의 베트남식 쌀국수', '대한민국 test5시 강남구 구로동 45', 9000, 5, 0, '/img/res5.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP,'공개'),
       ( '수연카페', '라떼', '부드러운 우유 라떼', '대한민국 test5시 강남구 화곡로 100', 4800, 6, 0, '/img/res6.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '도현김밥', '참치김밥', '든든한 참치마요 김밥', '대한민국 test5시 강남구 서초대로 200', 3500, 7, 0, '/img/res7.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '현우돈까스', '치즈돈까스', '고소한 치즈가 듬뿍', '대한민국 서울특별시 강남구 이태원로 50', 9500, 8, 0, '/img/res8.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
--        ( '세진커피', '카푸치노', '부드러운 거품의 커피', '서울특별시 동작구 상도로 120', 4800, 9, 0, '/img/res9.jpg', CURRENT_TIMESTAMP,
--         CURRENT_TIMESTAMP),
--        ( '서준버거', '불고기버거', '직접 구운 패티의 수제버거', '서울특별시 영등포구 여의대로 24', 8800, 10, 0, '/img/res10.jpg', CURRENT_TIMESTAMP,
...
--        ( '지민족발', '족발', '윤기가 흐르는 냄새 좋은 족발', '서울특별시 은평구 불광로 87', 25000, 11, 0, '/img/res11.jpg', CURRENT_TIMESTAMP,
--         CURRENT_TIMESTAMP),
       ( '인웅족발', '족발', '윤기가 흐르는 냄새 좋은 족발', '대한민국 서울특별시 강남구 ~~로 ~~~', 25000, 9, 0, '/img/res11.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '다연샌드위치', '클럽샌드위치', '든든한 점심 한 끼', '대한민국 서울특별시 강남구 청마로 93', 6500, 10, 0, '/img/res12.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개'),
       ( '아이스께끼', '아이스크림', '맛잇는 아이스크림', '대한민국 서울특별시 강남구 ~~로 ~~~', 25000, 11, 0, '/img/res11.jpg', CURRENT_TIMESTAMP,
         CURRENT_TIMESTAMP, '공개');
