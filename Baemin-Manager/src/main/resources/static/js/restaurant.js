...
//             event.preventDefault();
//
//             const id = this.getAttribute("data-id"); // 수정 시 id 있음
//
//             const data = {
//                 mainMenu: document.getElementById("menuName").value,
//                 price: document.getElementById("menuPrice").value,
...
//
//     if (!likeBtns.length || !likeCountSpan) {
//         console.warn("좋아요 버튼 또는 좋아요 카운트 span 없음");
//         return;
//     }
//
//     likeBtns.forEach(btn => {
...
//                     if (span) {
//                         span.textContent = result.liked ? "좋아요 취소" : "좋아요";
//                     }
//
//                     // data-liked 갱신
//                     btn.dataset.liked = result.liked;
